...
namespace streami {
  ...
  __both__
  inline mat3f make_LinearSpace3f(const vec3f x, const vec3f y, const vec3f z)
  {
    mat3f l;
    l.col0 = x;
    l.col1 = y;
  ...
  __both__
  inline float det(const mat3f l)
  {
  ...
  __both__
  inline void pyramidInterpolationDerivs(float *pcoords/*[3]*/,
                                         float *derivs/*[15]*/)
  {
    // r-derivatives
                              ...
                              )
  {
    ...
    box3f bbox{vec3f(FLT_MAX),vec3f(-FLT_MAX)};
    for (int i=0; i<5; ++i) {
  ...
  __both__
  inline bool intersectWedgeEXT(vec3f &value,
                                const vec3f &P,
                                const vec4f _v0,
                                const vec4f _v1,
                                const vec4f _v2,
